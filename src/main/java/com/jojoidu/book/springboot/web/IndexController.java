...
public class IndexController {
    ...
    public String index (Model model, @LoginUser SessionUser user){  //index 반환하므로 View Resolver가 처리.... Model 서버템플릿엔진에서 사용할 수 있는 객체 저장 .. postsService.findAllDesc()로 가져온 결과를 posts로 index머스테치 전달
